...
public class MidTermOceanEntity extends BaseEntity {
    ...
    public MidTermOceanDto toDto() {
        return MidTermOceanDto.builder().id(id).regId(regId).wf8(wf8).wh4AAm(wh4AAm).wh4BAm(wh4BAm).wh6BAm(wh6BAm)
                ...
                .wf4Am(wf4Am).wh8A(wh8A).wh10A(wh10A).wf5Am(wf5Am).wh3BAm(wh3BAm).wh10B(wh10B).wf6Am(wf6Am).wh5BPm(wh5BPm).wh5APm(wh5APm)
                .wh7APm(wh7APm).wh7BPm(wh7BPm).wh3APm(wh3APm).wh3BPm(wh3BPm).created(getCreated()).updated(getUpdated()).build();
    }
